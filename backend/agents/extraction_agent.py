...
SYSTEM_PROMPT = """You are a research extraction agent. Given the text of a \
web page and a research sub-question, extract the distinct factual claims in \
the page that are relevant to the sub-question. Ignore boilerplate, \
navigation text, and anything irrelevant to the question.
...
def extract_findings(sub_question: str, page_text: str) -> list[dict]:
